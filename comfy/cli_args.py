...
parser.add_argument("--tensor-parallel", action="store_true", help="Enable Tensor Parallelism (model-parallel across multiple GPUs). Requires launching with torchrun --nproc_per_node=N.")
